...
const Footer: React.FC = () => {
  const footerLinks = {
    product: [
      ...
      { name: 'Demo', href: '/estimation-demo' },
      { name: 'API', href: '/api-docs' }
    ],
    solutions: [
      { name: 'Fire Systems', href: '/solutions/fire' },
      { name: 'Security Systems', href: '/solutions/security' },
      { name: 'Access Control', href: '/solutions/access-control' },
      { name: 'Surveillance', href: '/solutions/surveillance' }
    ],
    resources: [
    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Fire & Security Systems</p>
              </div>
            </div>
            
            <p className="text-gray-300 mb-6 leading-relaxed">
              Transform your estimation process with AI-powered analysis, seamless data integration, 
              and professional proposal generation. Built for fire and security professionals.
            </p>
          ...
          {/* Solutions Links */}
          <div>
            <h4 className="text-sm font-semibold text-gray-300 uppercase tracking-wider mb-4">Solutions</h4>
            <ul className="space-y-3">
